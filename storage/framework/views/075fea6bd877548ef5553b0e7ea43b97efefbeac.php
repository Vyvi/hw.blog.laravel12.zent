...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('blog_assets/css/bootstrap.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('blog_assets/css/slippry.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('blog_assets/css/fonts.css')); ?>">
...
<body>
    ...
    ****************************************************************** --> 
    ...
    <header class="tada-container">
    	...
    	<div class="logo-container">
        	<a href="index.html"><img src="<?php echo e(asset('blog_assets/img/logo.png')); ?>" alt="logo" ></a>
            ...
            <?php if(!empty($categories)): ?>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($category->parent_id != null): ?>
                        ...
                        <li><a class="<?php if($key==0): ?> active <?php endif; ?>" href=""><?php echo e($category->name); ?></a>
 ...
 -->        
        ...
        <div class="tada-slider">
			<ul id="tada-slider">
				<li>
                	<img src="<?php echo e(asset('blog_assets/img/image-slider-1.jpg')); ?>" alt="image slider 1">
				...
				<li>
                	<img src="<?php echo e(asset('blog_assets/img/image-slider-2.jpg')); ?>" alt="image slider 2">
                    <div class="pattern"></div>
                    <div class="tada-text-container">
				...
				<li>
                	<img src="<?php echo e(asset('blog_assets/img/image-slider-3.jpg')); ?>" alt="image slider 3">
                	<div class="pattern"></div>
                    <div class="tada-text-container">
                    	<h1>AENEAN AC DIAM</h1>
                        <h2>VIVAMUS <span class="main-color">TINCIDUNT</span> FERMENTUM</h2>
                ...
                <li>
                	<img src="<?php echo e(asset('blog_assets/img/image-slider-4.jpg')); ?>" alt="image slider 4">
                	<div class="pattern"></div>
                    <div class="tada-text-container">
                    	<h1>AENEAN AC DIAM</h1>
                        <h2>VIVAMUS <span class="main-color">TINCIDUNT</span> FERMENTUM</h2>
    ...
    ****************************************************************** -->    
    ...
    <footer class="tada-container">
    	...
    	<div class="widget widget-gallery">
    		...
    		<div class="image">
            	<a href="#"><img src="<?php echo e(asset('blog_assets/img/img-gallery-1.jpg')); ?>" alt="image gallery 1"></a>
                <a href="#"><img src="<?php echo e(asset('blog_assets/img/img-gallery-2.jpg')); ?>" alt="image gallery 2"></a>
                <a href="#"><img src="<?php echo e(asset('blog_assets/img/img-gallery-3.jpg')); ?>" alt="image gallery 3"></a>
                <a href="#"><img src="<?php echo e(asset('blog_assets/img/img-gallery-4.jpg')); ?>" alt="image gallery 4"></a>
                <a href="#"><img src="<?php echo e(asset('blog_assets/img/img-gallery-5.jpg')); ?>" alt="image gallery 5"></a>
                <a href="#"><img src="<?php echo e(asset('blog_assets/img/img-gallery-6.jpg')); ?>" alt="image gallery 6"></a>
            </div>
    ...
    ****************************************************************** -->	
	...
	<script src="<?php echo e(asset('blog_assets/js/jquery-1.12.4.min.js')); ?>"></script>
	<script src="<?php echo e(asset('blog_assets/js/slippry.js')); ?>"></script>
